...
#plot the results
plot_single_metric(k_values, losses1, loss_cis1, "loss", "dataset 1 - kmeans - loss")
plot_single_metric(k_values, silhouettes1, silhouette_cis1, "silhouette value", "dataset 1 - kmeans silhouette score)")
plot_single_metric(k_values, losses2, loss_cis2, "loss", "Dataset 2 - kmeans - loss)")
plot_single_metric(k_values, silhouettes2, silhouette_cis2, "sillhouette value", "dataset 2 - kmeans silhouette score")